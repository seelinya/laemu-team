// AUTO-GENERIERT aus prisma/schema.prisma (prisma migrate diff).
// Wird zur Laufzeit ausgeführt, um die SQLite-Tabellen anzulegen — ohne CLI.
// Bei Schema-Änderungen neu erzeugen, siehe README.
